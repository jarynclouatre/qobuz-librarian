...
| `GET /api/queue/count` | A lightweight `{"count": N, "running": true/false, "signature": "..."}` for an "is anything active?" badge, without pulling the whole job list. The opaque signature changes when the active work changes. |
