...
Repair, after the first real scan of a whole library. A wrong ISRC tag was enough to make it offer to replace a healthy file, and an approved repair deletes your original with no grace period, so take this one.
