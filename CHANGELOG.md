...
- Adds startup checks that keep music, staging, and backup paths separate, forwards web-stream tuning through Docker, and strengthens readiness and release validation.
